...
const translations: Record<Language, Translations> = {
  ru: {
    common: {
      ...
      signature: 'Надежда Мельникова, ваш wellness-консультант',
      next: 'Далее',
      back: 'Назад',
      submit: 'Отправить',
      submitting: 'Отправка...',
      ...
      invalidPhone: 'Неверный формат телефона. Пример: +491234567890',
      ...
      phoneHintOk: '✓ Формат правильный',
      phoneHintBad: '⚠️ Формат: +код и номер, минимум 7 цифр',
      contactSectionTitle: 'Способ связи',
      contactSectionDescription: 'Укажите основной номер телефона. Дополнительные каналы связи можно добавить по желанию.',
      contactSectionOptionalButton: 'Добавить Telegram / Instagram (необязательно)',
  ...
  en: {
    common: {
      ...
      signature: 'Nadezhda Melnikova, your wellness consultant',
      next: 'Next',
      back: 'Back',
      submit: 'Submit',
      ...
      invalidPhone: 'Invalid phone format. Example: +491234567890',
      invalidTelegram: 'Invalid Telegram format. Use: @username',
      invalidInstagram: 'Invalid Instagram format. Use: username (without @)',
      phoneHintOk: '✓ Format is correct',
      phoneHintBad: '⚠️ Format: +country code and number, at least 7 digits',
      contactSectionTitle: 'Contact method',
      contactSectionDescription: 'Please provide your primary phone number. You can add extra contact channels if needed.',
      contactSectionOptionalButton: 'Add Telegram / Instagram (optional)',
